<template>
  <div class="max-w-6xl w-full flex justify-center mx-auto my-1 px-2 py-6">
    <div
    ...
    >
      ...
      <div class="p-6 bg-slate-200 dark:bg-gray-800">
        <h2 class="text-3xl font-extrabold dark:text-gray-200 mb-2">
          {{ product.title }}
        </h2>
        ...
        <button
          class="w-full px-6 md:px-24 flex justify-center gap-3 bg-rose-600 text-white font-bold py-3 rounded-lg hover:bg-orangr-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg"
